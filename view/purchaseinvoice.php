                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">View Of Invoice</h4>
...
<!--                                                        <th>Inquiry Date</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "select DISTINCT reference_no from invoice_list";
//                                                                print_r($sql);
                                                    ...
                                                    while ($rows = mysqli_fetch_array($resultset)) {
                                                        ...
                                                        echo "<td><a href='view/editinvoice.php?id=" . $rows[0] . "' target='_blank' class='btn btn-primary' id='" . $rows[0] . "'><i class='fa fa-save'></i> Edit</a></td>";
                                                        echo '</tr>';
                                                    }
                                                    ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <p><i class="fa fa-hand-point-right"></i> You can view the the purchase invoice.</p>
                                        <p><i class="fa fa-hand-point-right"></i> You can edit button then edit the invoice.</p>
                                    </div>
                                </div>
                            </div>
