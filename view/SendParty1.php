                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <form action="customFile/addProformaInvoice.php" id="form_data" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" >                                      
                                                ...
                                                <table border="3" width="1000px;" id="view_data" class="table table-striped table-bordered dt-responsive nowrap">                                                            
                                                    <tr>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td><b><center>PORT OF DISCHARGE<center></b><br></td>
                                                                                                                            <td colspan="2"><b><center>FINAL DESTINATION<center></b><br></td>
                                                                                                                                            ...
                                                                                                                                            $data = $dba->getRow("add_quotation INNER JOIN inquiry_item_list ON add_quotation.inquiry_item_id=inquiry_item_list.id", $field, "add_quotation.id=" . $id . " AND add_quotation.new_rate IS NOT NULL");
                                                                                                                                            $count = count($data);
                                                                                                                                            $i = 1;
                                                                                                                                            $totalrate = 0;
                                                                                                                                            $totalamt = 0;
