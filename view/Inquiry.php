                                            ...
                                            <div class="card-body">                   
                                                <form action="" id="form_data" class="form-horizontal" role="form" method="get" enctype="multipart/form-data" >  
                                                    <div class="form-group row">
                                                        ...
                                                        <input type="hidden" value="<?php echo $_GET['p_id'] ?>" name="party_id"/>
...
//                                                            $plastdate = $_GET['pto_date'];
                                                            ...
                                                            $sql = "SELECT inquiry.id,create_party.party_name,inquiry.inq_date,inquiry.inq_remark,inquiry.user_id,inquiry.status,COUNT(inquiry_item_list.inq_id) as total FROM inquiry_item_list LEFT JOIN inquiry ON inquiry_item_list.inq_id=inquiry.id INNER JOIN create_party ON create_party.id = inquiry.party_id WHERE  inquiry.party_id=" . $id . " GROUP BY inquiry.id";
                                                            //print_r($sql);
                            ...
                            <?php
                        } elseif (isset($_GET['from_date']) && isset($_GET['to_date']) && isset($_GET['party_id'])) {
                            ?>
                            <div class="page-content-wrapper">
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="card-body">                   
                                                <form action="" id="form_data" class="form-horizontal" role="form" method="get" enctype="multipart/form-data" >  
                                                    <div class="form-group row">
                                                        ...
                                                        <input type="hidden" value="<?php echo $_GET['party_id'] ?>" name="party_id"/>
                                                        <div class = "button-items">
                                                            <button type = "submit" id="btn_go" name="btn_go" class = "btn btn-primary waves-effect waves-light"><i class="fa fa-search"></i></button>
                                                        </div>
                                                        <div class="col-sm-3" align="right">
                                        ...
                                        <div class="card m-b-20">
                                            <div class="card-body">
                                                ...
                                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        <?php
//                                                                                    if (isset($_GET['from_date']) && isset($_GET['to_date']) && isset($_GET['p_id'])) {
//                                                                                        echo"Df";
                                                        $last_id = $dba->getLastID("branch_id", "create_user", "id=" . $_SESSION['user_id']);
                                                        $userid = $_SESSION['user_id'];
                                                        ...
                                                        include_once("../shreeLib/dbconn.php");
                                                        $sql = "SELECT inquiry.id,create_party.party_name,inquiry.inq_date,inquiry.inq_remark, inquiry.user_id,inquiry.status,COUNT(inquiry_item_list.inq_id) as total FROM inquiry_item_list LEFT JOIN inquiry ON inquiry_item_list.inq_id=inquiry.id INNER JOIN create_party ON create_party.id = inquiry.party_id WHERE inquiry.inq_date >='" . $firstdate . "' AND inquiry.inq_date <='" . $lastdate . "' AND inquiry.party_id='" . $_GET['party_id'] . "' GROUP BY inquiry.id";
//                                                        print_r($sql);
                                                        $resultset = mysqli_query($con, $sql);
                                                        while ($rows = mysqli_fetch_array($resultset)) {
