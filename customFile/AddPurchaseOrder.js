function AddEditPurchaseOrder() {
    $('#form_data').on('submit', (function (e) {
        ...
        if ($('#purchase_order_id').val()) {
            formData['purchase_order_id'] = $('#purchase_order_id').val();
        }
        $.ajax({
            type: 'POST',
            url: "customFile/AddPurchaseOrderPro.php",
            data: formData,
            cache: false,
            dataType: "json",
            contentType: false,
...
function AddEditPurchaseOrderItem() {
    $('#form_data').on('submit', (function (e) {
        e.preventDefault();
        var formData = new FormData(this);

        if ($('#purchase_order_item_id').val()) {
            formData['purchase_order_item_id'] = $('#purchase_order_item_id').val();
        }
        $.ajax({
            type: 'POST',
            url: "customFile/AddPurchaseOrderItemPro.php",
            data: formData,
            cache: false,
            dataType: "json",
            contentType: false,
...
function addPurchaseOrderItem() {
    ...
    $.ajax({
        ...
        enctype: 'multipart/form-data',
        data: {
            party_id: $("#purchase_order_item_id").val(),
            item_code:$("#item_code").val(),
            //item_name: $("#item_name").val(),
            item_quty: $("#item_quty").val(),
