...
if (isset($_GET['type']) && isset($_GET['id'])) {
    $pid = $_GET['id'];
    $edba = new DBAdapter();
    $field = array("sales_return.id,party_list.party_name,sales_return.s_invoice_no,sales_return.sale_date,sales_return.total_amount,sales_return.pay_type,sales_return.note");
    $edata = $edba->getRow("sales_return INNER JOIN party_list ON sales_return.party_id=party_list.id", $field, "sales_return.id=" . $_GET['id']);
    echo "<input type='hidden' id='id' value='" . $_GET['id'] . "'>";
    $field1 = array("count(sr_id)");
    $countrow = $edba->getRow("sales_return_item_list", $field1, "sr_id=" . $_GET['id']);
    ...
    <body class="text-editor">
                        ...
                        <div class="col-md-10 content-wrapper">
                            ...
                            <div class="content">
                                ...
                                <div class="main-content">
                                    ...
                                    <br><br>
                                    <form action="customFile/SalesReturnPro.php" id="form_data" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" >                                      
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" id="partyin">
                                                <input type="text" value="<?php echo ( isset($_GET['type']) && isset($_GET['id']) ? $edata[0][2] : '') ?>" name="s_invoice_no" id="partyinvoiceno" class="form-control" placeholder="Enter No." required>
                                            </div>
                                            <label for="ticket-name" class="col-sm-3 control-label" id="lblpartydate">Date</label>
                                            <div class="col-sm-9" id="partydue">
                                                <input type="date" id="datevalue" value="<?php echo ( isset($_GET['type']) && isset($_GET['id']) ? $edata[0][3] : '') ?>" name="sale_date" id="sale_date" class="form-control" placeholder="Date" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" id="partydue">
                                                ...
                                                <input type="text" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][4] : '') ?>" name="total_amount" id="txt_total"   class="form-control" placeholder="Total" readonly required>
                                            </div>

                                            <input type="hidden" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][4] : '') ?>" name="sr_amount" id="sr_total">

                                            <label for="ticket-name" class="col-sm-3 control-label" id="lblpartydate">Type</label>
                                            <div class="col-sm-9" id="typelist">
                                                <input type="hidden" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][5] : '') ?>" name="sr_type" id="sr_typel" >
                                            ...
                                            <div class="col-sm-9" id="partynote">
                                                <input type="text" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][6] : '') ?>" name="note" id="note" class="form-control" placeholder="Note" required>
                                            </div>
                                        </div>
                                        ...
                                        <table id="item_table" class="item_table" border="1" cellspacing="0">
                                            ...
                                            <tbody id="view_data1" name="view_data">
                                                <tr id = "row1" data='no'>
                                                    ...
                                                    <td><input type='text' id='total1' value="0.0" class='total1' name='total[]' required readonly/> </td>
        ...
        <script type="text/javascript">
                                function numbers() {
                                    ...
                                    var my_object = "sales_return_id=" + sidd;
                                    //alert(my_object);
                                    $.ajax({
                                        url: 'getViewData.php',
                                        dataType: "html",
        ...
        <script type="text/javascript">
            ...
            function deleterow(sales_return_id)
            {
                ...
                for (var i = 1; i <= count; ++i) {
                    ...
                    if (cb.checked) {
                        if (rowattri === 'no') {
                            ...
                            var id = document.getElementById('sr_id' + values).value;
                            var my_object = {"s_return_id": id, "sales_return_id": sales_return_id};
                            $.ajax({
                                url: 'Delete.php',
                                dataType: "html",
                                data: my_object,
