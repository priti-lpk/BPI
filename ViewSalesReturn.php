...
if (isset($_GET['type']) && isset($_GET['id'])) {
    $edba = new DBAdapter();
    $edata = $edba->getRow("sales_return", array("*"), "id=" . $_GET['id']);
    echo "<input type='hidden' id='sales_return_id' value='" . $_GET['id'] . "'>";
}
                            ...
                            <div class="row">
                                <div class="col-lg-4 ">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">View Sales Return</li>
                                    </ul>
                                </div>
                            </div>
                            <!-- main -->
                                            ...
                                            <div class="col-md-12">
                                                <div class="widget widget-table">
                                                    <div class="widget-header">
                                                        <h3><i class="fa fa-table"></i>View Sales Return</h3>
                                                    </div>
...
//                                                                $id = $_GET['party_id'];
                                                                ...
                                                                include_once("shreeLib/dbconn.php");
                                                                $sql = "SELECT sales_return.id,party_list.party_name,sales_return.total_amount,sales_return.pay_type,sales_return.note, sales_return.user_id FROM sales_return INNER JOIN party_list ON party_list.id = sales_return.party_id WHERE sales_return.sale_date >='" . $firstdate . "' AND sales_return.sale_date <='" . $lastdate . "' and party_list.branch_id=" . $last_id;
                                                                $resultset = mysqli_query($con, $sql);
                                                                while ($rows = mysqli_fetch_array($resultset)) {
                                                                    echo "<tr>";
                                                                    echo "<td>" . $rows['id'] . "</td>";
...
//        var my_object = {"sr_id": party_id, "f_date": f_date, "l_date": l_date, "dt_data": detedata, "ed_data": editdata};
//        //alert(my_object);
//        $.ajax({
//            url: 'getViewData.php',
//            dataType: "html",
    ...
    function SetForDelete(id) {
        swal({
            ...
            closeOnCancel: false
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        location.href = "Delete.php?type=sales_return&id=" + id;
