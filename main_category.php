...
if (isset($_GET['type']) && isset($_GET['id'])) {
    ...
    $field = array("*");
    $data = $edba->getRow("main_category", $field, "id=" . $_GET['id']);
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="customFile/main_categoryPro.php" id="form_data" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                <h4 class="mt-0 header-title">Textual inputs</h4>
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Main Catgeory</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text"  placeholder="Main Category Name" id="main_cat_name" name="main_cat_name" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $data[0][1] : ''); ?>" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Image</label>
                                                    <div class="col-sm-10">
                                                        <input type="file" id="main_image" name="main_image" class="form-control filestyle" data-input="false" data-buttonname="btn-secondary" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    $dba = new DBAdapter();
                                                    $field = array("*");
                                                    $data = $dba->getRow("main_category", $field, "1");
                                                    $count = count($data);
                                                    $k = 1;
                                                    if ($count >= 1) {
...
//                                                            echo "<td>" . $subData[3] . "</td>";
                                                            ...
                                                            echo "</td>";
                                                            echo "<td> <img src=Images/main/" . $subData[2] . "  alt='image' class='img-responsive' height=50 width=50 style='background: black;'></td>";
                                                            echo "<td><a href='main_category.php?type=edit&id=" . $subData[0] . "' class='btn btn-primary waves-effect waves-light'>Edit</a> <button class='btn btn-danger btn_delete' id='" . $subData[0] . "' onclick='SetForDelete(this.id);'><i class='fa fa-trash-o'>  Delete</button></td>";
