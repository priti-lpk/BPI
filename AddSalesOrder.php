...
if (isset($_GET['type']) && isset($_GET['id'])) {
    $pid = $_GET['id'];
    $edba = new DBAdapter();
    $field = array("sales_order_list.id,party_list.party_name,sales_order_list.sale_date,sales_order_list.total_amount,sales_order_list.note,sales_order_list.pay_tax");
    $edata = $edba->getRow("sales_order_list INNER JOIN party_list ON sales_order_list.party_id=party_list.id", $field, "sales_order_list.id=" . $_GET['id']);
    echo "<input type='hidden' id='id' value='" . $_GET['id'] . "'>";
    $field1 = array("count(srl_id)");
    $countrow = $edba->getRow("sales_order_item_list", $field1, "srl_id=" . $_GET['id']);
...
<html lang="en" class="no-js">
    ...
    <body class="text-editor">
                        ...
                        <div class="col-md-10 content-wrapper">
                            ...
                            <div class="content">
                                ...
                                <div class="main-content">
                                    ...
                                    <br><br>
                                    <form action="customFile/AddSalesOrderPro.php" id="form_data" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" >                                      
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" id="partydue">
                                                <input type="date" id="datevalue" value="<?php echo ( isset($_GET['type']) && isset($_GET['id']) ? $edata[0][2] : '') ?>" name="sale_date" id="sale_date" class="form-control" placeholder="Date" required>
                                            </div>
                                            ...
                                            <input type="hidden" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][3] : '') ?>" name="sl_amount" id="sl_total">
        ...
        <script type="text/javascript">
            ...
            function deleterow(sales_order_id)
            {
                ...
                for (var i = 1; i <= count; ++i) {
                    ...
                    if (cb.checked) {
                        if (rowattri === 'no') {
                            ...
                            var my_object = {"sr_list_id": id, "sales_order_id": sales_order_id};
                            $.ajax({
                                url: 'Delete.php',
                                dataType: "html",
                                data: my_object,
