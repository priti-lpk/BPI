...
if (isset($_GET['type']) && isset($_GET['id'])) {
    $pid = $_GET['id'];
    $edba = new DBAdapter();
    $field = array("purchase_list.id,party_list.party_name,purchase_list.p_invoice_no,purchase_list.pl_date,purchase_list.total_amount,purchase_list.pay_type,purchase_list.note,purchase_list.pay_tax");
    $edata = $edba->getRow("purchase_list INNER JOIN party_list ON purchase_list.party_id=party_list.id", $field, "purchase_list.id=" . $_GET['id']);
    echo "<input type='hidden' id='id' value='" . $_GET['id'] . "'>";
    $field1 = array("count(pl_id)");
    $countrow = $edba->getRow("purchase_item_list", $field1, "pl_id=" . $_GET['id']);
    echo "<input type='hidden' id='rowcount' value='" . $countrow[0][0] . "'>";
}
if (isset($_GET['order_id'])) {
    $id = $_GET['order_id'];
    $order_data = new DBAdapter();
    $field = array("purchase_order_list.id,party_list.party_name, purchase_order_list.pl_date,purchase_order_list.total_amount,purchase_order_list.pay_tax,purchase_order_list.note");
    $orderdata = $order_data->getRow("purchase_order_list INNER JOIN party_list ON purchase_order_list.party_id = party_list.id", $field, "purchase_order_list.id=" . $id);

    $edba = new DBAdapter();
    $field1 = array("count(prl_id)");
    $countrow_order = $edba->getRow("purchase_order_item_list", $field1, "prl_id=" . $_GET['order_id']);
    ...
    <body class="text-editor">
                        ...
                        <div class="col-md-10 content-wrapper">
                            ...
                            <div class="content">
                                ...
                                <div class="main-content">
                                    <!-- WYSIWYG EDITOR -->
                                    <form action="./customFile/AddPurchaseListPro.php" id="form_data" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" >                                      
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" id="partyin">
                                                <input type="text" value="<?php echo ( isset($_GET['type']) && isset($_GET['id']) ? $edata[0][2] : '') ?>" name="p_invoice_no" id="partyinvoiceno" class="form-control" placeholder="InvoiceNo." required>
                                            </div>
                                            ...
                                            <div class="col-sm-9" id="partydue">
                                                ...
                                                ?>" name="pl_date" id="pl_date" class="form-control" placeholder="Date" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][4] : '') ?>" name="pl_amount" id="pl_total">
                                            ...
                                            <div class="col-sm-9" id="typelist">
                                                ...
                                                <select name="pay_type" id="type" class="select2" required>
                                                    <?php if (isset($_GET['id'])) { ?>
                                                        ...
                                                        ?>>Cash</option>
                                                        <option value="Debit"<?php echo $edata[0][5] == 'Debit' ? ' selected="selected"' : ''; ?>>Debit</option>
                                                    <?php } else {
                                                        ?>
                                            ...
                                            <div class="col-sm-9" id="typelist">
                                                ...
                                                <select name="pay_tax" id="type" class="select2" required>
                                                    <?php if (isset($_GET['id'])) { ?>
                                                        <option value = "GST"<?php echo $edata[0][7] == 'GST' ? ' selected="selected"' : '';
                                                        ?>>GST</option>
                                                        <option value="WGST"<?php echo $edata[0][7] == 'WGST' ? ' selected="selected"' : ''; ?>>WGST</option>
                                        ...
                                        <div class="form-group">
                                            <label for="ticket-name" class="col-sm-3 control-label" id="lblpartynote">Note</label>
                                        ...
                                        <table id="item_table" class="item_table" border="1" cellspacing="0">
                                            ...
                                            <tbody id="view_data1" name="view_data">
                                                <tr id = "row1" data='no'>
                                                    ...
                                                    <td><input type='text' id='total1' class='total1' name='total[]' required readonly/> </td>
                                        ...
                                        <div class="widget-footer">
                                            ...
                                            <input type="hidden" name="order_id" id="orderid" value="<?php echo (isset($_GET['order_id']) ? $_GET['order_id'] : '0') ?>">
        ...
        <script type="text/javascript">
                                ...
                                function numbers() {
                                    ...
                                    var my_object = "purchase_id=" + pidd;
                                    $.ajax({
                                        url: 'getViewData.php',
                                        dataType: "html",
                                        data: my_object,
                ...
                for (var i = 1; i <= count; ++i) {
                    ...
                    if (cb.checked) {
                        ...
                        if (rowattri === 'no') {
                            ...
                            var id = document.getElementById('p_id' + values).value;
                            var my_object = {"p_list_id": id, "purchase_id": purchase_id};
                            $.ajax({
                                url: 'Delete.php',
                                dataType: "html",
                                data: my_object,
