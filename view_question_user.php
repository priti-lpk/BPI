...
if (isset($_GET['type']) && isset($_GET['id'])) {
    ...
    $field = array("*");
    $data = $edba->getRow("add_newuser", $field, "id=" . $_GET['id']);
...
<html lang="en">
    ...
    <head>
        ...
        <title><?php
            if (isset($_GET['type']) && isset($_GET['id'])) {
                echo 'Edit Question User';
            } else {
                echo 'Add Question User';
            }
            ?></title>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    include_once 'shreeLib/DBAdapter.php';
                                                    $dba = new DBAdapter();
                                                    $field = array("user_master.id,user_master.user_name,user_master.address,user_master.mobile_no,countries.cname,states.state_name,user_master.city,user_master.user_type");
                                                    $data = $dba->getRow("user_master INNER JOIN countries ON user_master.country_id=countries.id INNER JOIN states ON user_master.state_id=states.id", $field, "1");
                                                    $count = count($data);
                                                    $k = 1;
                                                    if ($count >= 1) {
