...
if (isset($_GET['type']) && isset($_GET['id'])) {
    $pid = $_GET['id'];
    $edba = new DBAdapter();
    $field = array("purchase_order_list.id,party_list.party_name,purchase_order_list.pl_date,purchase_order_list.total_amount,purchase_order_list.note,purchase_order_list.pay_tax");
    $edata = $edba->getRow("purchase_order_list INNER JOIN party_list ON purchase_order_list.party_id=party_list.id", $field, "purchase_order_list.id=" . $_GET['id']);
    echo "<input type='hidden' id='id' value='" . $_GET['id'] . "'>";
    $field1 = array("count(prl_id)");
    $countrow = $edba->getRow("purchase_order_item_list", $field1, "prl_id=" . $_GET['id']);
                        ...
                        <div class="col-md-10 content-wrapper">
                            ...
                            <div class="content">
                                ...
                                <div class="main-content">
                                    <!-- WYSIWYG EDITOR -->
                                    <form action="customFile/AddPurchaseOrderPro.php" id="form_data" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" >                                      
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" id="partydue">
                                                <input type="date"  id="datevalue" value="<?php echo ( isset($_GET['type']) && isset($_GET['id']) ? $edata[0][2] : '') ?>" name="pl_date" id="pl_date" class="form-control" placeholder="Post Title" required>
                                            </div>
                                            <label for="ticket-name" class="col-sm-3 control-label" id="lblpartydate">Total</label>
                                            <div class="col-sm-9" id="partydue">
                                                <input type="text" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][3] : '') ?>" name="total_amount" id="txt_total"   class="form-control" placeholder="Total" readonly required>
                                            </div>
                                            <input type="hidden" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][3] : '') ?>" name="pl_amount" id="pl_total">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" id="typelist">
                                                ...
                                                <select name="pay_tax" id="type" class="select2" required>
                                                    <?php if (isset($_GET['id'])) { ?>
                                                        <option value = "GST"<?php echo $edata[0][5] == 'GST' ? ' selected="selected"' : '';
                                                        ?>>GST</option>
                                                        <option value="WGST"<?php echo $edata[0][5] == 'WGST' ? ' selected="selected"' : ''; ?>>WGST</option>
                                                    <?php } else {
                                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9" id="partynote">
                                                    <input type="text" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][4] : '') ?>" name="note" id="note" class="form-control" placeholder="Note" required>
                                                </div>
                                            </div>
                                            ...
                                            <table id="item_table" class="item_table" border="1" cellspacing="0">
                                                ...
                                                <tbody id="view_data1" name="view_data">
                                                    <tr id = "row1" data='no'>
                                                        ...
                                                        <td id="qtn"><input type='text' id='qnty1' class='qnty1' name='item_qnty[]' onchange="changeQnty(this);" required /> </td>
