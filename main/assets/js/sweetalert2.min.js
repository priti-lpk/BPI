! function(e, t) {
    ...
    function n() {
        function n(t) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(o)) {
                for (var a = n.target || n.srcElement, r = -1, i = 0; i < x.length; i++)
                    if (a === x[i]) {
                        r = i;
                        break
                    }
                9 === o ? (a = -1 === r ? k : n.shiftKey ? 0 === r ? x[x.length - 1] : x[r - 1] : r === x.length - 1 ? x[0] : x[r + 1], H(n), l(a)) : 13 === o || 32 === o ? -1 === r && I(k, n) : 27 === o && u.allowEscapeKey === !0 && I(B, n)
            }
        }
        ...
        o(u), c(), i();
        var y = b();
        u.timer && (y.timeout = setTimeout(function() {
        ...
        var g, p = function(t) {
                ...
                switch (n.type) {
                    ...
                    case "mouseup":
                    case "focus":
                        r ? o.style.backgroundColor = a(u.confirmButtonColor, -.1) : l && (o.style.backgroundColor = a(u.cancelButtonColor, -.1));
                        break;
                    case "mouseout":
                    case "blur":
                        r ? o.style.backgroundColor = u.confirmButtonColor : l && (o.style.backgroundColor = u.cancelButtonColor);
                        break;
                    case "mousedown":
                        r ? o.style.backgroundColor = a(u.confirmButtonColor, -.2) : l && (o.style.backgroundColor = a(u.cancelButtonColor, -.2));
                        break;
                    case "click":
                        if (r && u.callback && i) u.callback(!0), u.closeOnConfirm && s();
                        else if (u.callback && i) {
                            var c = String(u.callback).replace(/\s/g, ""),
                                m = "function(" === c.substring(0, 9) && ")" !== c.substring(9, 10);
                            m && u.callback(!1), u.closeOnCancel && s()
                        } else s()
                }
            },
            v = y.querySelectorAll("button");
        for (g = 0; g < v.length; g++) v[g].onclick = p, v[g].onmouseover = p, v[g].onmouseout = p, v[g].onmousedown = p;
        m = t.onclick, t.onclick = function(t) {
            var n = t || e.event,
                o = n.target || n.srcElement;
            o === h() && u.allowOutsideClick && s()
        };
        var k = y.querySelector("button.confirm"),
            B = y.querySelector("button.cancel"),
            x = y.querySelectorAll("button, input:not([type=hidden]), textarea");
        for (g = 0; g < x.length; g++) x[g].addEventListener("focus", p, !0), x[g].addEventListener("blur", p, !0);
        d = e.onkeydown, e.onkeydown = n, k.style.borderLeftColor = u.confirmButtonColor, k.style.borderRightColor = u.confirmButtonColor, e.swal.toggleLoading = function() {
    ...
    function o(n) {
        ...
        r.type = "text/css", r.id = p, r.innerHTML = "@media screen and (max-width: " + n.width + "px) {.sweet-alert {max-width: 100%;left: 0 !important;margin-left: 0 !important;}}", a.appendChild(r);
        var l = o.querySelector("h2"),
            i = o.querySelector("p"),
            s = o.querySelector("button.cancel"),
            c = o.querySelector("button.confirm"),
            u = o.querySelector("hr");
        if (l.innerHTML = x(n.title).split("\n").join("<br>"), e.jQuery ? i = $(i).html(x(n.text.split("\n").join("<br>")) || n.html) : (i.innerHTML = x(n.text.split("\n").join("<br>")) || n.html, i.innerHTML && E(i)), n.customClass && k(o, n.customClass), q(o.querySelectorAll(".icon")), n.type) {
            ...
            switch (E(f), n.type) {
                case "success":
                    k(f, "animate"), k(f.querySelector(".tip"), "animate-success-tip"), k(f.querySelector(".long"), "animate-success-long");
                    break;
                case "error":
                    k(f, "animate-error-icon"), k(f.querySelector(".x-mark"), "animate-x-mark");
                    break;
                case "warning":
        ...
        if (n.imageUrl) {
            ...
            if (y.style.backgroundImage = "url(" + n.imageUrl + ")", E(y), n.imageSize) {
        ...
        n.showCancelButton ? s.style.display = "inline-block" : q(s), n.showConfirmButton ? c.style.display = "inline-block" : q(c), n.showConfirmButton || n.showCancelButton || q(u), c.innerHTML = x(n.confirmButtonText), s.innerHTML = x(n.cancelButtonText), c.style.backgroundColor = n.confirmButtonColor, s.style.backgroundColor = n.cancelButtonColor, c.className = "confirm", k(c, n.confirmButtonClass), s.className = "cancel", k(s, n.cancelButtonClass), n.animation === !0 ? B(o, "no-animation") : k(o, "no-animation")
    }
    ...
    function i() {
        var e = b();
        L(h(), 10), E(e), k(e, "show-sweet-alert"), B(e, "hide-sweet-alert"), u = t.activeElement, setTimeout(function() {
            k(e, "visible")
        }, 500)
    }
    ...
    function s() {
        var n = b();
        M(h(), 5), M(n, 5), B(n, "showSweetAlert"), k(n, "hideSweetAlert"), B(n, "visible");
        var o = n.querySelector(".icon.success");
        B(o, "animate"), B(o.querySelector(".tip"), "animate-success-tip"), B(o.querySelector(".long"), "animate-success-long");
        var a = n.querySelector(".icon.error");
        B(a, "animate-error-icon"), B(a.querySelector(".x-mark"), "animate-x-mark");
        var r = n.querySelector(".icon.warning");
        B(r, "pulse-warning"), B(r.querySelector(".body"), "pulse-warning-ins"), B(r.querySelector(".dot"), "pulse-warning-ins"), e.onkeydown = d, t.onclick = m, u && u.focus(), f = void 0, clearTimeout(n.timeout);
