...
if (isset($_GET['type']) && isset($_GET['id'])) {
    ...
    $field = array("*");
    $data = $edba->getRow("countries", $field, "id=" . $_GET['id']);
    ...
    <body>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="customFile/countryriesPro.php" id="form_data" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                <h4 class="mt-0 header-title">Textual inputs</h4>
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Country Name</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text"  placeholder="country Name" id="cname" name="cname" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $data[0][1] : ''); ?>" required="">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    $dba = new DBAdapter();
                                                    $field = array("*");
                                                    $data = $dba->getRow("countries", $field, "1");
                                                    $count = count($data);
                                                    $k = 1;
                                                    if ($count >= 1) {
                                                        foreach ($data as $subData) {
                                                            ...
                                                            echo "<td><a href='countries.php?type=edit&id=" . $subData[0] . "' class='btn btn-primary waves-effect waves-light'>Edit</a> <button class='btn btn-danger btn_delete' id='" . $subData[0] . "' onclick='SetForDelete(this.id);'><i class='fa fa-trash-o'>  Delete</button></td>";
        ...
        <script type="text/javascript">
            ...
            function SetForDelete(id) {
                location.href = "Delete.php?type=country&id=" + id;
