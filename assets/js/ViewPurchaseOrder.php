...
if (isset($_GET['type']) && isset($_GET['id'])) {
    $edba = new DBAdapter();
    $edata = $edba->getRow("purchase_order_list", array("*"), "id=" . $_GET['id']);
    echo "<input type='hidden' id='purchase_order_id' value='" . $_GET['id'] . "'>";
}
if (isset($_SESSION['user_id'])) {
    ...
    $purchase_right = $edba->getRow("role_rights INNER JOIN  module ON role_rights.mod_id= module.id", $field, " role_rights.role_create=1 and module.mod_pagename='AddPurchaseList.php' and role_rights.user_id=" . $_SESSION['user_id']);
                                    ...
                                    <form action="" id="form_data" class="form-horizontal" role="form" method="get" enctype="multipart/form-data" >  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3" id="partydue">
                                                <input type="date"  value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][1] : '') ?>" name="from_date" id="from_date" class="form-control"  required>
                                            </div>
                                            <!--                                    </div><br><Br><br>
                                                                                <div class="form-group">-->
                                            <label for="ticket-name" class="col-sm-2 control-label" id="lblfrom">To</label>
                                            <div class="col-sm-3" id="partydue">
                                                <input type="date"  value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][1] : '') ?>" name="to_date" id="to_date" class="form-control"  required>
                                            </div>
                                            <!--                                    </div><br><br>
                                                                                <div class="form-group">-->
                                            ...
                                            <div class="col-md-12">
                                                <div class="widget widget-table">
                                                    <div class="widget-header">
                                                        <h3><i class="fa fa-table"></i>View Purchase Order</h3>
                                                    </div>
                                                        ...
                                                        <table id="view_data" class="table table-sorting table-striped table-hover datatable">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <?php if ($purchase_right[0][0] == 1) { ?> <th>Purchase Now</th><?php } ?>
                                                                </tr>
...
//        var purcs_data =<?php echo (isset($_SESSION['user_id']) ? $pur_create : '') ?>;
//
//        var f_date = $('#from_date').val();
//        var l_date = $('#to_date').val();
//        var party_id = $("#party_list").val();
//        var my_object = {"pr_id": party_id, "f_date": f_date, "l_date": l_date, "dt_data": detedata, "ed_data": editdata, "purcs_create": purcs_data};
//
//        $.ajax({
//            url: 'getViewData.php',
//            dataType: "html",
    ...
    function SetForDelete(id) {
        swal({
            ...
            closeOnCancel: false
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        location.href = "Delete.php?type=purchase_order_list&id=" + id;
